...
class StateCart extends State<Cart> with TickerProviderStateMixin {
  ...
  removeAddon(id, varientId,cartID) async {
    ...
    request.fields
        .addAll({'add_on_id': '${id}', 'cart_id': cartID, 'product_variant_id' : varientId});
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: () {
                                          ...
                                          removeAddon(e.id.toString(), cartList[index].varientId,cartList[index].cartID);
                                        },
                                        child: Icon(
                                          Icons.clear,
                                          color: Colors.black,
      ...
      try {
        ...
        if (cartList[index].productList![0].addOnList != null &&
          ...
          cartList[index].productList![0].addOnList!.forEach((element) {
            ...
            qtyList.add((/*int.parse(element.quantity ?? "0") + */int.parse(qty))
                .toString());
          });
        }
  ...
  Future<void> placeOrder(String? tranId) async {
    ...
    if (_isNetworkAvail) {
      ...
      try {
        ...
        print(
            "sdsfssfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfs" + parameter.toString());
        Response response =
