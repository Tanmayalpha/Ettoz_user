...
class StateAddress extends State<AddAddress> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    /* GetLocation getLocation = GetLocation((value) {
      if (mounted)
        setState(() {
          latitude = latitudeFirst.toString();
          longitude = longitudeFirst.toString();
        });
    });
    getLocation.getLoc();*/
    ...
    if (widget.update!) {
      ...
      _areaController.text = item.area.toString();
  ...
  bool validateAndSave() {
    ...
    form.save();
    if (form.validate()) {
      if (_cityController.text == null || _cityController.text.isEmpty) {
        setSnackbar(getTranslated(context, 'cityWarning')!);
      } else if (_areaController.text == null || _areaController.text.isEmpty) {
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      ...
                      onPressed: () async {
                        ...
                        //     });
                        //
                        //    // countryC.text = result.
                        //     print("checking address here now ${address} and  and${result.name}");
                        //     Navigator.of(context).pop();
                        //   },
