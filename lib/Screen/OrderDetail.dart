                    ...
                    children: [
                      ...
                      Padding(
                          padding: EdgeInsetsDirectional.only(
                              start: 15.0, end: 15.0),
                          child: Text(
                            widget.model!.itemList![0].deliveryBoyName
                                    .toString() +
                                ",",
                          )),
                      Padding(
                          ...
                          child: InkWell(
                            onTap: () {
                              _launchCaller(
                                  widget.model!.itemList![0].deliveryBoyNumber);
                            },
                            child: Text(
                                widget.model!.itemList![0].deliveryBoyNumber
                                    .toString(),
...
//                 ),
  ...
  getOrderDetails(OrderModel model) {
    print("checking addon data list ${model.addonList!.length}");
                            ...
                            itemBuilder: (c, i) {
                              return ListTile(
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    Text(
                                        "Price: \u{20B9}${model.addonList![i].price}"),
                                    Text(
                                        "Total Price: \u{20B9}${model.addonList![i].totalAmount}"),
                                  ],
                                ),
                                trailing: Text(
      ...
      itemBuilder: (context, i) {
        ...
        if (activeStatus != '') {
          if (orderItem.status == activeStatus) {
            ...
            if (orderItem.listStatus!.contains(WAITING)) {
              aDate =
                  orderItem.listDate![orderItem.listStatus!.indexOf(WAITING)];
            }
            if (orderItem.listStatus!.contains(PLACED)) {
              pDate =
                  orderItem.listDate![orderItem.listStatus!.indexOf(PLACED)];
            }
            if (orderItem.listStatus!.contains(PROCESSED)) {
              prDate =
            ...
            if (orderItem.listStatus!.contains(SHIPED)) {
              sDate =
                  orderItem.listDate![orderItem.listStatus!.indexOf(SHIPED)];
            }
            if (orderItem.listStatus!.contains(DELIVERD)) {
              dDate =
                  orderItem.listDate![orderItem.listStatus!.indexOf(DELIVERD)];
            }
            if (orderItem.listStatus!.contains(CANCLED)) {
              cDate =
                  orderItem.listDate![orderItem.listStatus!.indexOf(CANCLED)];
            }
            if (orderItem.listStatus!.contains(RETURNED)) {
              rDate =
                  orderItem.listDate![orderItem.listStatus!.indexOf(RETURNED)];
            }
            List att = [], val = [];
            if (orderItem.attr_name!.isNotEmpty) {
              att = orderItem.attr_name!.split(',');
