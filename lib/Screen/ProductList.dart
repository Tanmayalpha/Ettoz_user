...
String? vegValue;
  ...
  void getProduct(String top) {
    ...
    print("new paremters here ${parameter}");
...
/*  getAppbar() {
  ...
  Widget productItem(int index, bool pad) {
    if (index < productList.length) {
      ...
      print("checking price here ${price} and ${model
                ...
                children: [
                  ...
                  double.parse(model
                      ...
                      ? Flexible(
                          child: Row(
                            children: <Widget>[
                           off == 0.0 || off  == 0  || off == "" || off == "0.0" ? SizedBox.shrink() :   Flexible(
                                child: Text(
                                  double.parse(model
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: DropdownButton(
                                  ...
                                  // Array list of items
                                  items: ['Veg','Non-veg'].map((String items) {
