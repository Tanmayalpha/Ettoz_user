...
class StateProfile extends State<MyProfile> with TickerProviderStateMixin {
  ...
  removePhoto() async {
    var headers = {
      'Cookie': 'ci_session=e2504188384f975438166f10169ae4529fa04d55'
    };
    ...
    if (response.statusCode == 200) {
      ...
      print("checking final response here now ${jsonResponse}");
      setState(() {
  ...
  Future<void> setUpdateUser(String userID,
      [oldPwd, newPwd, username, userEmail, userMobile]) async {
    ...
    if (!error) {
      ...
      if ((username != "") && (userEmail != "")) {
        ...
        settingProvider.setPrefrence(MOBILE, userMobile);
        userProvider.setMobile(userMobile);
      }
    ...
    return ListView(
      ...
      children: <Widget>[
        ...
        _getDrawerItem(getTranslated(context, 'CONTACT_LBL')!,
            'assets/images/pro_aboutus.svg'),
        // _getDivider(),
        _getDrawerItem("Favorite Restaurant", "assets/images/desel_fav.svg"),
        _getDrawerItem(
...
/*  _getDivider() {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          } else if (title == 'Favorite Restaurant') {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => FavoriteRestaurant()));
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Selector<UserProvider, String>(
                        selector: (_, provider) => provider.mob,
                        builder: (context, userMobile, child) {
                          print("yes mobile ${userMobile}");
                          return setMobileField(userMobile);
                        }),
  ...
  Widget setMobileField(String mob) => Padding(
        padding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 15.0),
        child: Container(
          padding:
              EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom),
